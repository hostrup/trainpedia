...
- [ ] **M8** [Medium] ~~`src/lib/components/TimelineCanvas.svelte:359`~~ — **Overført:** samme mangel findes i `src/lib/tubemap/TubeMap.svelte`s `zoomContainer` (arves fra det gamle mønster). Ikke løst i F5.4 — genåbnet mod TubeMap.svelte.
